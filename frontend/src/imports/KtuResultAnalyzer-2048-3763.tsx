import svgPaths from "./svg-gcr9c7jm76";
...
function TableRow11() {
  return (
    <div className="absolute bg-[#f9fafb] h-[50.388px] left-0 top-[503.47px] w-[1068.8px]" data-name="Table Row">
      <TableCell110 />
      <TableCell111 />
      <TableCell112 />
      <TableCell113 />
...
function TableRow15() {
  return (
    <div className="absolute bg-[#f9fafb] h-[50.388px] left-0 top-[705.02px] w-[1068.8px]" data-name="Table Row">
      <TableCell154 />
      <TableCell155 />
      <TableCell156 />
      <TableCell157 />
...
function Button5() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[1064px] size-[56px] top-[2826.4px]" data-name="Button">
      <Container51 />
    </div>
  );
}
...
function Container52() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[727.2px] items-start left-[1152px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] top-[2187.2px] w-[400px]" data-name="Container">
      <Container53 />
      <Container57 />
    </div>
  );
