import svgPaths from "./svg-ebmlpw6qzm";
...
function Button5() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[1064px] size-[56px] top-[639.2px]" data-name="Button">
      <Container51 />
    </div>
  );
}
...
function Container52() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[727.2px] items-start left-[1152px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] top-0 w-[400px]" data-name="Container">
      <Container53 />
      <Container57 />
    </div>
  );
